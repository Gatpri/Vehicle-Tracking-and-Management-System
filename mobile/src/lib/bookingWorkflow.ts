...
// what is permitted.
//
// Copied byte-for-byte from the web app's src/lib/bookingWorkflow.ts: it is
// pure TypeScript with no DOM in it, so there was nothing to adapt, and both
// clients must label a booking identically anyway. Keep them in sync — a
// change to the web file belongs here too.
